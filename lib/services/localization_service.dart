class LocalizationService {
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'custom_text_hint': 'Enter custom instruction or move name',
      'add_custom_text': 'Add Custom Text',
      'training_mode': 'Training Mode',
      'select_item_to_train': 'Select the First Item number to Train',
      'beginner': 'Beginner',
      'advanced': 'Advanced',
      'expert': 'Expert',
      'verify': 'Verify',
      'training_result': 'Training Result',
      'correct_combo': 'Correct Combo!',
      'incorrect_combo': 'Incorrect Combo',
      ...
      'backup_global_title': 'Global Backup',
      'backup_global_subtitle': 'Full Backup (All Data)',
      'backup_global_restore_title': 'Restore Everything',
      'backup_global_restore_subtitle': 'Restore from a full ZIP backup',
      'restore_everything': 'Restore Everything',
      'export_description': 'Export your series',
      ...
      'help_start_next': 'Start / Next',
      'help_start_next_desc': 'Add a new independent step.',
      'help_simultaneous_desc': 'Merge with previous step (simultaneous).',
      'help_sequence_desc': 'Chain onto previous step (sequence).',
      'help_answer_desc': 'Add a counter-attack to the selected step.',
      'help_finish_desc': 'Save the combo.',
      'help_cancel_desc': 'Discard changes.',
      'help_actions_options': 'Actions Options',
      'help_structure': 'Structure',
    ...
    'fr': {
      ...
      'custom_text_hint': 'Entrez une instruction ou un nom de mouvement',
      'add_custom_text': 'Ajouter le texte',
      'training_mode': 'Mode d\'entraînement',
      'select_item_to_train': 'Sélectionnez le premier item à entraîner',
      'beginner': 'Débutant',
      'advanced': 'Avancé',
      'expert': 'Expert',
      'verify': 'Vérifier',
      'training_result': 'Résultat de l\'entraînement',
      'correct_combo': 'Combo Correct !',
      'incorrect_combo': 'Combo Incorrect',
      'your_attempt': 'Votre Tentative',
      'original_move': 'Mouvement Original',
      ...
      'share': 'Partager',
      'restore_everything': 'Tout Restaurer',
      ...
      'keep_screen_on_desc': 'Empêcher le verrouillage de l\'écran pendant l\'entraînement',
      ...
      'help_start_next': 'Démarrer / Suivant',
      'help_start_next_desc': 'Ajoute une nouvelle étape indépendante.',
      'help_simultaneous_desc': 'Combine avec l\'étape précédente (simultané).',
      'help_sequence_desc': 'Enchaîne sur l\'étape précédente (séquence).',
      'help_answer_desc': 'Ajoute une contre-attaque à l\'étape sélectionnée.',
      'help_finish_desc': 'Enregistre le combo.',
      'help_cancel_desc': 'Abandonne les modifs.',
      'help_actions_options': 'Options des Actions',
      'help_structure': 'Structure',
